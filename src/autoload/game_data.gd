...
const RECIPES: Dictionary = {
	"salt_grill":
	{
		...
		"unlock_level": 1,
		"exp_multiplier": 1.0,
		"allowed_fish": ["aji", "mejina", "kasago", "isaki", "saba", "boss_kurodai"],
	...
	"sashimi":
	{
		...
		"unlock_level": 2,
		"exp_multiplier": 1.2,
		"allowed_fish": ["aji", "mejina", "isaki", "saba", "boss_kurodai"],
	...
	"simmered":
	{
		...
		"unlock_level": 3,
		"exp_multiplier": 1.35,
		"allowed_fish": ["mejina", "kasago", "isaki", "boss_kurodai"],
