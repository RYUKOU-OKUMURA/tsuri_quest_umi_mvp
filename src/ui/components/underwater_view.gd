...
func _draw_showcase_background() -> void:
	...
	if _showcase_color_grade != null:
		_draw_cover_texture(_showcase_color_grade, Rect2(Vector2.ZERO, size), Color(1.0, 1.0, 1.0, 0.18))
	if _showcase_seabed_detail != null:
		_draw_cover_texture(_showcase_seabed_detail, Rect2(Vector2.ZERO, size), Color(1.0, 1.0, 1.0, 0.30))
