...
FISH_VARIANT_DIR = ROOT / "assets" / "showcase" / "fish"
...
FISH_ART_SOURCES = {
    ...
    "ishidai": {
        "source": "expansion_1",
        "contact_crop": (27, 1195, 471, 1455),
    },
    "akahata": {
        "source": "expansion_1",
        "contact_crop": (512, 1207, 992, 1449),
    },
    "fuefukidai": {
        "source": "expansion_2",
    ...
    "rouninaji": {
        "source": "expansion_2",
        "contact_crop": (19, 1199, 513, 1445),
    },
    "kajiki": {
        "source": "expansion_2",
        "contact_crop": (511, 1185, 1009, 1445),
    },
    "mahaze": {
        "source": "dedup_20260708_2",
        "contact_crop": (430, 500, 880, 790),
        "flip_runtime_source": True,
    },
    "umitanago": {
        "source": "dedup_20260708_4",
        "contact_crop": (0, 484, 464, 751),
        "flip_runtime_source": True,
        "runtime_offset_x": 55,
    },
    ...
    "nenbutsudai": {
        "source": "dedup_20260708_2",
        "contact_crop": (880, 480, 1310, 800),
        "flip_runtime_source": True,
        "runtime_offset_x": 75,
    },
    "makogarei": {
        "source": "dedup_20260708_3",
        "contact_crop": (1014, 669, 1521, 956),
        "flip_runtime_source": True,
        "runtime_offset_x": 45,
    },
    "ishigarei": {
        "source": "dedup_20260708_4",
        "contact_crop": (1308, 112, 1762, 391),
        "flip_runtime_source": True,
        "runtime_offset_x": 45,
    },
    ...
    "sawara": {"source": "dedup_20260708_2", "contact_crop": (0, 520, 460, 780), "flip_runtime_source": True},
    "datsu": {"template": "kamasu", "tint": "#9db8b8", "tint_strength": 0.36, "scale_x": 1.18, "scale_y": 0.54, "markings": "needle_line"},
    "hirasouda": {
        "source": "dedup_20260708_3",
        "contact_crop": (1020, 321, 1524, 612),
        "flip_runtime_source": True,
        "runtime_offset_x": 30,
    },
    "suma": {
        "source": "dedup_20260708_3",
        "contact_crop": (9, 696, 529, 932),
        "flip_runtime_source": True,
    },
    "ojisan": {
        "source": "dedup_20260708_1",
    ...
    "takabe": {
        "source": "dedup_20260708_3",
        "contact_crop": (516, 699, 1033, 931),
        "flip_runtime_source": True,
    },
    "ira": {
        "source": "dedup_20260708_2",
        "contact_crop": (0, 70, 450, 360),
        "flip_runtime_source": True,
        "runtime_offset_x": 35,
    },
    "meichidai": {
        "source": "dedup_20260708_3",
        "contact_crop": (10, 39, 518, 353),
        "flip_runtime_source": True,
        "runtime_offset_x": 45,
    },
    "shimaaji": {
        "source": "dedup_20260708_4",
        "contact_crop": (3, 76, 464, 396),
        "flip_runtime_source": True,
        "runtime_offset_x": 85,
    },
    ...
    "gingameaji": {
        "source": "dedup_20260708_4",
        "contact_crop": (421, 102, 908, 393),
        "flip_runtime_source": True,
        "runtime_offset_x": 70,
    },
    "kaiwari": {
        "source": "dedup_20260708_4",
        "contact_crop": (865, 115, 1351, 400),
        "flip_runtime_source": True,
        "runtime_offset_x": 95,
    },
    "kihada": {
        "source": "dedup_20260708_3",
        "contact_crop": (2, 349, 531, 638),
        "flip_runtime_source": True,
        "runtime_offset_x": 60,
    },
    "binnaga": {
    ...
    "mebachi": {
        "source": "dedup_20260708_3",
        "contact_crop": (492, 378, 1031, 637),
        "flip_runtime_source": True,
        "runtime_offset_x": 35,
    },
    "akamutsu": {
        "source": "dedup_20260708_2",
        "contact_crop": (880, 50, 1320, 370),
        "flip_runtime_source": True,
        "runtime_offset_x": 75,
    },
    "kinmedai": {
        "source": "dedup_20260708_2",
        "contact_crop": (430, 60, 900, 360),
        "flip_runtime_source": True,
        "runtime_offset_x": 45,
    },
    "ara": {
        "source": "dedup_20260708_4",
        "contact_crop": (1308, 502, 1764, 751),
        "flip_runtime_source": True,
        "runtime_offset_x": 15,
    },
    "medai": {
        "source": "dedup_20260708_2",
        "contact_crop": (1300, 50, 1774, 350),
        "flip_runtime_source": True,
        "runtime_offset_x": 45,
    },
}
