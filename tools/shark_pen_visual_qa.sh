...
mkdir -p "$GODOT_HOME"
rm -f /tmp/tsuri_shark_pen.png /tmp/tsuri_shark_pen_compare.png

echo "==> Build shark pen reference"
python3 "$ROOT/tools/build_shark_pen_reference.py"
...
path = Path("/tmp/tsuri_shark_pen.png")
