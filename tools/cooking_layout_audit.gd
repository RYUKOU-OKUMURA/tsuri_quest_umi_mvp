...
func _audit_cook_select() -> void:
	...
	_expect_named_control_size("COOK_SELECT", screen, "RecipeDishThumb_salt_grill", Vector2(80.0, 112.0))
	_expect_named_control_size("COOK_SELECT", screen, "RecipeDishImage_salt_grill", Vector2(70.0, 106.0))
