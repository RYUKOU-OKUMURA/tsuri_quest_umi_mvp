...
func _audit_cook_select() -> void:
	...
	_expect_named_control_size("COOK_SELECT", screen, "RecipeDishThumb_salt_grill", Vector2(80.0, 86.0))
	_expect_named_control_size("COOK_SELECT", screen, "RecipeDishImage_salt_grill", Vector2(70.0, 80.0))
	...
	_expect_named_control_size("COOK_SELECT", screen, "CookDetailExpRow", Vector2(220.0, 46.0))
	_expect_named_control_size("COOK_SELECT", screen, "CookDetailEffectRow", Vector2(220.0, 46.0))
