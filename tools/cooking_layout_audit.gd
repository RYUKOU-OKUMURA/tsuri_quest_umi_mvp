...
func _audit_cook_select() -> void:
	...
	_expect_named_control_size("COOK_SELECT", screen, "SelectedDishTitlePlate", Vector2(260.0, 60.0))
	_expect_named_control_size("COOK_SELECT", screen, "SelectedDishTitle", Vector2(240.0, 38.0))
	_expect_named_control_size("COOK_SELECT", screen, "SelectedDishSubtitle", Vector2(240.0, 16.0))
...
func _audit_exp_gain() -> void:
	...
	_expect_named_control_size("EXP_GAIN", screen, "ExpGainBanner", Vector2(460.0, 80.0))
	_expect_named_control_size("EXP_GAIN", screen, "ExpGainTitle", Vector2(300.0, 38.0))
	_expect_named_control_size("EXP_GAIN", screen, "ExpEnergyTrail", Vector2(24.0, 100.0))
	_expect_named_control_size("EXP_GAIN", screen, "ExpBurstFrame", Vector2(440.0, 300.0))
	_expect_named_control_size("EXP_GAIN", screen, "ExpGainValue", Vector2(220.0, 78.0))
	...
	_expect_named_control_size("EXP_GAIN", screen, "MealTableSpread", Vector2(160.0, 64.0))
...
func _audit_exp_gain_level_up() -> void:
	...
	_expect_named_control_size("EXP_GAIN_LEVELUP", screen, "ExpGainBanner", Vector2(460.0, 80.0))
	_expect_named_control_size("EXP_GAIN_LEVELUP", screen, "ExpGainTitle", Vector2(300.0, 38.0))
	_expect_named_control_size("EXP_GAIN_LEVELUP", screen, "ExpEnergyTrail", Vector2(24.0, 100.0))
	_expect_named_control_size("EXP_GAIN_LEVELUP", screen, "ExpBurstFrame", Vector2(440.0, 300.0))
	_expect_named_control_size("EXP_GAIN_LEVELUP", screen, "ExpGainValue", Vector2(220.0, 78.0))
	...
	_expect_named_control_size("EXP_GAIN_LEVELUP", screen, "MealTableSpread", Vector2(160.0, 64.0))
...
func _audit_level_up() -> void:
	...
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelUpDialog", Vector2(1020.0, 560.0))
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelUpTitleBand", Vector2(960.0, 150.0))
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelUpTitle", Vector2(540.0, 86.0))
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelUpLevelLine", Vector2(460.0, 54.0))
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelUpSourceLine", Vector2(260.0, 24.0))
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelCrownAsset", Vector2(180.0, 38.0))
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelLaurelLeftAsset", Vector2(130.0, 110.0))
	_expect_named_control_size("LEVEL_UP_OVERLAY", panel, "LevelLaurelRightAsset", Vector2(130.0, 110.0))
...
func _audit_status_summary() -> void:
	...
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusSubtitle", Vector2(220.0, 32.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusHeaderPlayerBadge", Vector2(30.0, 30.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusHeaderExpBox", Vector2(460.0, 42.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusHeaderLevel", Vector2(50.0, 24.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusHeaderExpBar", Vector2(150.0, 16.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusHeaderExpValue", Vector2(100.0, 20.0))
	...
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusPlayerHero", Vector2(180.0, 140.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusPlayerPortrait", Vector2(70.0, 90.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusNextExpText", Vector2(52.0, 34.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusPlayerExpBar", Vector2(52.0, 18.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusStatRowEnergy", Vector2(160.0, 30.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusStatRowPower", Vector2(160.0, 30.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusStatRowDefense", Vector2(160.0, 30.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusStatRowSpeed", Vector2(160.0, 30.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusStatRowLuck", Vector2(160.0, 30.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusMealDishImage", Vector2(150.0, 126.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusCoolerArt", Vector2(120.0, 126.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusMoneyArt", Vector2(120.0, 126.0))
	_expect_named_control_size("STATUS_SUMMARY", screen, "StatusClockArt", Vector2(120.0, 126.0))
