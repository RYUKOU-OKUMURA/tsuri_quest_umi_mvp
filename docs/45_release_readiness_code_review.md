...
3. 本書 §5と§8から1 concernだけ選ぶ
4. UIならdocs/19と対象QA、E7 / E11なら当該phase docを読む
5. briefに「触る / 触らない / DoD / 検証」を明記
6. 独立作業だけfan-outする。player_progress.gdのSAVE briefは直列
...
最初にユーザー判断が得られない場合の安全な開始候補:

1. SAVE-01 future version guard
2. SAVE-02 save failure propagation
3. UI-QUEST
4. UI-READY

ただしSAVE-01とSAVE-02は同時並列にしない。
