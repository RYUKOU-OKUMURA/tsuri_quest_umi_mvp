...
最終更新: 2026-07-08 / 状態: **docs/39 水中ファイト基盤UI刷新 採用・freeze改定済み / docs/35 P1/P2 差し替え済み**
...
| 旧派生crop修正とP2新規ソース化 | 1 | `rouninaji.contact_crop` 上端切断を修正し、rouninaji/ishidai/akahata/kajiki系を再生成。後続のdocs/35 P2バッチ2で `shimaaji/gingameaji/kaiwari/ishigakidai/oomonhata` は新規 `source + contact_crop` に置換済み。`nushi_rock_breakwater` はP3再評価へ回す | 採用 |
