...
最終更新: 2026-07-05 / 状態: v1 freeze / RarityStyles共通化済み / R1 Palette確認済み / 帰港導線右下統一済み
...
| 状態 | 判定 | 証拠 |
|---|---|---|
| 通常選択 | 採用 | `docs/qa/evidence/fish_market/2026-07-05_return_right_select_compare.png` |
| 売却確認 | 採用 | `docs/qa/evidence/fish_market/2026-07-05_return_right_confirm_compare.png` |
| 売却完了 | 採用 | `docs/qa/evidence/fish_market/2026-07-05_return_right_sold_compare.png` |
| 空状態 | 採用 | `docs/qa/evidence/fish_market/2026-07-05_return_right_empty_compare.png` |
