...
| QA-RELEASE（release verifier骨格） | 完了 | 2026-07-11 | settings smoke追加後の31対象を自動列挙＋manifest完全一致で管理。特殊3件presence、process-group timeout、run固有HOME / logs、source・manifest安定性、未知WARNING拒否、RC証跡開始終了再hashを実装。固定RC evidenceは未入力 |
