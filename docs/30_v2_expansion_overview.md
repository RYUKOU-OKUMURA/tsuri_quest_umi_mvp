...
作成日: 2026-07-06
状態: 仕様確定・V2実装進行中（E0〜E6・E10、docs/35〜44の完了分、Release Gate 0、ID-01、SAVE-01〜02・UI-QUEST-01・UI-READY-01・docs/33 M0/C0を前提化。最小export spike、SAVE-03〜04、E7、E11、release_verifyは未完）
...
2. **Release Gate 1残（SAVE-03〜04）** — SAVE-01の将来版セーブ保護とSAVE-02の保存失敗伝播は完了。意味検証付きbackup選択、旧依頼repairを直列で実施。詳細とbriefはdocs/45
...
| RIGHTS-01A | **基盤完了・外部証拠待ち** | `[RIGHTS-01A]=pending`。`docs/31`、`LICENSE.md`、`THIRD_PARTY_NOTICES.md`、権利監査scriptは存在。U-01〜U-08のうち出所・入力権利・icon・商標・権利者名をRC固定前にcloseする |
...
| docs/45 リリース前監査フォローアップ | 是正中 | **現在の最優先** | Release Gate 0・ID-01・SAVE-01〜02・UI-QUEST-01・UI-READY-01・M0・C0は完了。最小export spike、SAVE-03〜04、E7、E11、release_verifyが残る。詳細briefはdocs/45 |
