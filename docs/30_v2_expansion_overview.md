...
作成日: 2026-07-06
状態: 仕様確定・V2実装進行中（E0〜E6・E10、docs/35〜44の完了分、Release Gate 0、SAVE-01〜02・UI-QUEST-01・UI-READY-01・docs/33 M0/C0を前提化。SAVE-03〜04、E7、E11、release_verifyは未完）
...
| E7 | 未着手 | — | ローンチ前。E5 の後 |
| E11 | 一部着手 | — | docs/31 素材台帳を作成済み。Release Gate 0は2026-07-11完了。E11実装部はE7後 |
...
| docs/45 リリース前監査フォローアップ | 是正中 | **現在の最優先** | Release Gate 0・SAVE-01〜02・UI-QUEST-01・UI-READY-01・M0・C0は完了。SAVE-03〜04、E7、E11、release_verifyが残る。詳細briefはdocs/45 |
