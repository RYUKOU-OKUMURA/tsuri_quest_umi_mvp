...
4. **E11（着手可）** — 設定・入力・表示・製品外装を完成。docs/33 M0/C0と依頼/READYの局所P1は完了済み
...
| E11実装 | **着手可** | settings spineを単一ownerで開始し、画面別入力だけをfan-out |
...
| E11 | 一部着手（本実装着手可） | — | docs/31 素材台帳、Release Gate 0、ID-01、REL-01最小exportは完了。E7完了により設定等の画面実装へ着手可 |
