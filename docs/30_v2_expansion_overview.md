...
作成日: 2026-07-06
状態: 仕様確定・V2実装進行中（E0〜E6・E10とdocs/35〜44・docs/33 M0の完了分を前提化。docs/33 C0とdocs/45是正キューは未着手）
...
4. **E11 ＋ docs/33 C0 ＋ 依頼/READYの局所P1** — 設定・入力・表示・製品外装と、実スクショで再確認したP1をclose（M0は完了）
...
| docs/33 C0（調理P1掃除） | 未着手 | E11 と同梱（ローンチ品質） | 残像wash・タイトル衝突・グリフ潰れ |
| docs/45 リリース前監査フォローアップ | 是正中 | **現在の最優先** | SAVE-01・UI-QUEST-01・UI-READY-01・M0は完了。Release Gate 0、SAVE-02〜04、C0、E7、E11、release_verifyが残る。詳細briefはdocs/45 |
