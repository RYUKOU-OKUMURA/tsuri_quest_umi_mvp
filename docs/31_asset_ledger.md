...
| `tools/process_fishing_time_slot_assets.py` | E5 Stage 2時間帯素材4枚。OpenAI生成ソース `tools/source_assets/fishing_time_slots/` を既存解像度へクロップ/リサイズ |
