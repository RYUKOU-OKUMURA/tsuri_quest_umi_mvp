...
|---|---|---|---|---|
| 魚ポートレート・泳ぎシート（70種×2点） | `assets/showcase/fish/` | **OpenAI（Codex App / ChatGPT の画像生成）**（2026-07-06 ユーザー確認） | **商用利用可**。OpenAI Terms of Use は Output の権利をユーザーに帰属させる（生成時点の規約による）。帰属表記不要 | ✓ |
