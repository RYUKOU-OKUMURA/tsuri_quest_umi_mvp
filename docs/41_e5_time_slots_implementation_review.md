...
作成日: 2026-07-08  
状態: スライス1〜3 実装完了（2026-07-08）。スライス4（Stage 2 素材）のみ未着手  
...
| 4 | 釣行 Stage 2 | 最小素材 4 枚 + 配線 + freeze 改定 | Stage 1 不合格記録 | 未着手。Stage 1 不合格記録済みのため着手可能。素材ブリーフ（docs/30 §4-3）を先に書くこと |
