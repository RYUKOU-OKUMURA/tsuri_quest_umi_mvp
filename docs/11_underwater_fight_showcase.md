...
| `tools/build_reference_underwater_background.py` | 水中背景ビルダー | 参照画像クロップ、主役/演出マスク、色面補完、キャンバス拡張、中央/右側の密度焼き込み | 中間PNGを残さず、最終背景だけを決定的に再生成する |
