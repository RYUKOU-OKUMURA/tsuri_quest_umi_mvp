...
1. `sidebar_frame.png` は右パネル幅拡張、魚カード用 `kurodai_card_portrait.png` 分離、紙面の内部構造追加、行動文の意味改行、行動/タックル下段カード専用アイコン追加、下段カード本文の短縮と余白調整まで完了。次は残る罫線感を減らし、手描きの情報カードらしい内側装飾へ寄せる。
