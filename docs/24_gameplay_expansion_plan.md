...
- 採用証跡: `docs/qa/evidence/underwater_fight/2026-07-04_surface_weather_asset_contact_sheet.png` / `docs/qa/evidence/underwater_fight/2026-07-04_surface_weather_ready_compare.png` / `docs/qa/evidence/underwater_fight/2026-07-04_surface_scene_ready_weather_runtime_compare.png` / `docs/qa/evidence/underwater_fight/2026-07-04_surface_fog_state_consistency_compare.png` / `docs/qa/evidence/underwater_fight/2026-07-04_surface_weather_status_icon_compare.png`
